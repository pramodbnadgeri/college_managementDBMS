...
<div id="admin">
        ...
        <div id="lmain">
                <a href="#" title="logo" ><img src="picture/logo.png" height="80" width="80"/></a>
                <div id="leftmanu">
                	<div >
                 ...
                 <div>
                    ...
                    <div>
                    	<a href="index.php" class="customer" title="Shift+8">&nbsp;logout</a>
                    </div>
    ...
    <div id="rmain">
    	<div id="pic_manu">
		<h1><center><b> SIR MVIT </b></center></h1>
         ...
         <div id="menu2">
                ...
                <li id="li_menu"><a href="#">Article</a>
                    ...
                    <ul>
                        ...
                        <li id="li_submenu"><a href="?tag=view_artical" class="stocks">View Article</a></li>
                    </ul>
				</li>
